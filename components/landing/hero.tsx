...
export function Hero() {
  ...
  const stats = [
    { value: "4", label: t.landing.stats.provinces },
    { value: "24", label: t.landing.stats.licences },
    { value: "12", label: t.landing.stats.partners },
  ];

  const previewRows = [
    { icon: Compass, title: p.landingPoint, body: p.landingPointBody },
    { icon: ClipboardCheck, title: p.registrations, body: p.registrationsBody },
    { icon: ShieldCheck, title: p.compliance, body: p.complianceBody },
    { icon: Handshake, title: p.partners, body: p.partnersBody },
  ];
      ...
      <div className="container grid gap-12 py-20 lg:grid-cols-12 lg:gap-16 lg:py-28">
        <div className="lg:col-span-7">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <p className="text-sm text-slate-500 sm:ml-2">{t.landing.heroNote}</p>
          </div>
        ...
        <div className="lg:col-span-5">
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <h2 className="text-sm font-semibold text-navy-800">{p.title}</h2>
