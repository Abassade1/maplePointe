...
export function HowItWorks() {
  ...
  const steps = [
    { number: "01", icon: Search, title: h.assess, body: h.assessBody },
    { number: "02", icon: Map, title: h.guide, body: h.guideBody },
    { number: "03", icon: Handshake, title: h.connect, body: h.connectBody },
  ];
    ...
    <section id="how-it-works" className="border-b border-slate-200 py-20 lg:py-24">
      <div className="container">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-lg leading-relaxed text-slate-600">{h.subtitle}</p>
        </div>
